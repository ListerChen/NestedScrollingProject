...
public class MountingActivity extends AppCompatActivity {
    ...
    private void initViews() {
        mNestedLinearLayout = findViewById(R.id.mounting_nested_linear_layout);
        mBanner = findViewById(R.id.mounting_banner);
        mCommentRecyclerView = findViewById(R.id.mounting_rv_comments);
